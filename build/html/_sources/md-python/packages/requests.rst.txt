...
**r.content** You can also access the response body as bytes, for
non-text requests:
...
(will be form-encoded), bytes, or file-like object to send in the body
...
Using the json parameter in the request will change the Content-Type in
the header to application/json.
